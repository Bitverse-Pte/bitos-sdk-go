...
import (
	...
	"github.com/BitOS-labs/bitos-sdk-go/client"
)
...
var (
	testAcc1 = testAcc{
		name:     "acc1",
		addr:     "bitos1n855w0jwp2n04dtxvuu3zedxdlxz5c5u85mxv3",
	...
	testAcc2 = testAcc{
		name:     "acc2",
		addr:     "bitos199l57ddd3jepsu3rjen5snyd5x58y2qv9ydpja",
...
func newClient() (*client.BitosClient, error) {
