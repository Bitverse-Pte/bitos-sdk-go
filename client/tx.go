...
func Prepare(client *BitosClient, signer sdk.AccAddress, msg sdk.Msg, options ...Option) (sdktx.Factory, error) {
...
// Broadcast Sign and broadcast to node
// It is retryable.
func (client *BitosClient) Broadcast(txf sdktx.Factory, msgs ...sdk.Msg) (res *tx.BroadcastTxResponse, err error) {
...
func (client *BitosClient) broadcast(txf sdktx.Factory, msgs ...sdk.Msg) (*tx.BroadcastTxResponse, error) {
...
// it is retryable
func (client *BitosClient) CalculateGas(txf sdktx.Factory, msgs ...sdk.Msg) (res *tx.SimulateResponse, gas uint64, err error) {
	retryableFunc := func() error {
		txf, err = setupAccNumberSequence(client.ctx, client.accountRetriever, txf)
		if err != nil {
			return err
...
func (client *BitosClient) calculateGas(txf sdktx.Factory, msgs ...sdk.Msg) (*tx.SimulateResponse, uint64, error) {
...
func (client *BitosClient) GetTx(hash string) (*tx.GetTxResponse, error) {
	return client.TxClient.GetTx(context.Background(), &tx.GetTxRequest{Hash: hash})
}

func (client *BitosClient) GetTxsEvent(req *tx.GetTxsEventRequest) (*tx.GetTxsEventResponse, error) {
